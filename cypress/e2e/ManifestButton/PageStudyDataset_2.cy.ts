...
describe('Page d\'une étude (Dataset) - Bouton Manifest', () => {
  ...
  it('Vérifier les informations affichées - Modal', () => {
    ...
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Structural Variations (SVs)"] td').eq(1).contains(/^3$/).should('exist');
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Structural Variations (SVs)"] td').eq(2).contains(/^3$/).should('exist');
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Structural Variations (SVs)"] td').eq(3).contains(/^3 B$/).should('exist');
    ...
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Quality Control Metrics"] td').eq(1).contains(/^3$/).should('exist');
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Quality Control Metrics"] td').eq(2).contains(/^3$/).should('exist');
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Quality Control Metrics"] td').eq(3).contains(/^3 B$/).should('exist');
    ...
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Aligned Reads"] td').eq(3).contains(/^3 B$/).should('exist');
    ...
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Single Nucleotide Variants (SNVs)"] td').eq(1).contains(/^3$/).should('exist');
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Single Nucleotide Variants (SNVs)"] td').eq(2).contains(/^3$/).should('exist');
    cy.get('[class*="DownloadFileManifestModal_table"] [data-row-key="Single Nucleotide Variants (SNVs)"] td').eq(3).contains(/^949.95 MB$/).should('exist');
