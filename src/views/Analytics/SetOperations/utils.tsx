...
export const vennDictionary: TVennChartDictionary = {
  ...
  set: {
    ...
    tooltipVariantExplo: intl.get('screen.analytics.venn.set.tooltipVariantExplo'),
  ...
  save: {
    ...
    titleVariant: intl.get('screen.analytics.venn.save.titleVariant'),
    getEntityText: (index: string, entityCount: number) => {
      ...
      } else if (index === INDEXES.VARIANT) {
        return intl.get('screen.analytics.venn.save.entity.variants', {
          count: entityCount,
        });
      } else {
  ...
  participants: intl.get('screen.analytics.venn.participants'),
  biospecimens: intl.get('screen.analytics.venn.biospecimens'),
  files: intl.get('screen.analytics.venn.files'),
