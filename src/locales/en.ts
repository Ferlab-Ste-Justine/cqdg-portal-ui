  ...
  entities: {
    ...
    file: {
      ...
      sequencing_experiment: {
        ...
        identifiant: 'ID',
        profiling_resolution: 'Profiling Resolution',
        instrument_model: 'Instrument Model',
        pore_type: 'Pore Type',
        is_imputed: 'Imputed',
        strategy_resolution: 'Strategy + Resolution',
        platform_instrument_model: 'Platform + Instrument Model',
        selection: 'Library Selection',
        target_loci: 'Targeted Loci',
        protocol: 'Protocol',
      },
